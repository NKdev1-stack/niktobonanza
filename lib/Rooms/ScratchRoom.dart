   ...
   initializeInterstitialAds() async{
    ...
    AppLovinMAX.setInterstitialListener(InterstitialListener(
      ...
      onAdDisplayedCallback: (ad) {
        ...
        _ref.child(_authUID.currentUser!.uid)
            .update({
...
// Levels
  ...
  Widget build(BuildContext context) {
    ...
    title: Row(children: [Icon(Icons.line_weight_rounded),SizedBox(width: MediaQuery.of(context).size.width *.02,),const Text("Scratch Game")],),
    ),
               ...
               Row(
                 ...
                 children: [
                   Column(
                     ...
                     children: [
                       ...
                       const   SizedBox(height: 5,),
                        Text("Niktos",style: TextStyle(color: Colors.white),),

                           Text("$Niktos",style: TextStyle(color: Colors.yellowAccent)),
                   ...
                   Column(
                     ...
                     mainAxisAlignment: MainAxisAlignment.center,
                     children: [
                       Image.asset("assets/images/scratches.png",height: 35,width: 35,),
                       const   Text("Scratch",style: TextStyle(color: Colors.white)),
                           Text("$Scratch",style: TextStyle(color: Colors.yellow)),
                     ],
                   ),
                   Column(
                     crossAxisAlignment: CrossAxisAlignment.center,
                ...
                children: [
                  ElevatedButton(onPressed: (){
                    ...
                    setState(() {
                      ...
                      if(Scratch <=0){
                        Utils().message("Watch Ad to Get More Chances");
                      }else{
                      ...
                      style: ElevatedButton.styleFrom(shape: CircleBorder(),shadowColor: Colors.black,elevation: 1)),
                  Center(child: const Text(textAlign: TextAlign.center,"Punch Me \n👊",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),)),
           ...
           Container(
             ...
             child: Row(
              crossAxisAlignment: CrossAxisAlignment.center,
               mainAxisAlignment: MainAxisAlignment.center,
               children: [
                 Text("More Scratch",style: TextStyle(color: Colors.white,fontSize: 20),),
      ...
      return AlertDialog(
        ...
        content: Scratcher(
            ...
            onThreshold: (){
                ...
                if(rnds == 10 || rnds == 8 || rnds == 6 || rnds == 4|| rnds == 1 ||  rnds == 2 ||  rnds == 5 ||  rnds == 3){
                  initializeInterstitialAds();
                  if (INTisReady) {
               ...
               try{
                 if(Scratch >0){
                   ...
                   ref.child(_authUID.currentUser!.uid).update({
                     ...
                     'Scratch': ServerValue.increment(-1)
                   });
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Image.asset("assets/images/trophy.png",height: MediaQuery.of(context).size.height *0.18,),
                    ),
                    Center(child: Text("You Won $rnds ",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),))
