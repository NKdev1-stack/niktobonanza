...
class _DicerState extends State<Dicer>  with TickerProviderStateMixin {
  ...
  // Advertisement
  final String _interstitial_ad_unit_id = "6de043508d679164";
  final String _rewarded_ad_unit_id =  "b6f634278187fefc";
  ...
  initializeInterstitialAds() async{
    ...
    AppLovinMAX.setInterstitialListener(InterstitialListener(
      ...
      onAdDisplayedCallback: (ad) {
        ...
        _rDb.child(_fAuth.currentUser!.uid)
            .update({
...
// Ads load
    ...
    animation =CurvedAnimation(parent: _animationController, curve: Curves.fastEaseInToSlowEaseOut) ;
  ...
  void Roll(){
   ...
   _animationController.forward();
    setState(() {
      ...
      if(diceRandomNo == 1 || diceRandomNo == 4 || diceRandomNo == 6){
        if (INTisReady) {
    ...
    return Container(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Row(children: [Icon(Icons.casino),SizedBox(width: MediaQuery.of(context).size.width *.02,),const Text("Dice Game")],),
          ),
         ...
         child: Column(
            children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          SizedBox(height: 6,),
                          Image.asset("assets/images/dice.png",height: 35,width: 32,),
                          SizedBox(height: 3,),
                          const   Text("Dices",style: TextStyle(color: Colors.white)),
                          Text("$Dices",style: TextStyle(color: Colors.yellow)),
                        ],
                      ),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
              ...
              const Center(child:  Padding(
                ...
                child: Text("Tap to Roll",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 15),),
              )),
              SizedBox(height: MediaQuery.of(context).size.height *0.06,),
                ...
                RotationTransition(
                    ...
                    child: GestureDetector(
                        ...
                        child: Visibility(
                            visible: diceshow,
                            child: Center(child: Image.asset("assets/images/d$diceRandomNo.png",height: 280,width: 280,))))),
                ...
                child: ElevatedButton(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("More Dice",style: TextStyle(color: Colors.white,fontSize: 20),),
